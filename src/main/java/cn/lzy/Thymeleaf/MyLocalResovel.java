...
public class MyLocalResovel implements LocaleResolver {
    ...
    public Locale resolveLocale(HttpServletRequest httpServletRequest) {
        // 获取页面手动切换传递的语言参数l
        String mLanguage = httpServletRequest.getParameter("Language"); //zh_CN en_US
